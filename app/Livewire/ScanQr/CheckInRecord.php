...
use App\Models\CheckInRecord as ModelsCheckInRecord;
use Carbon\Carbon;
use Livewire\Attributes\Computed;
use Livewire\Attributes\On;
use Livewire\Component;

class CheckInRecord extends Component
{
    use WithBulkActions;
    ...
    #[On('muat-ulang','reload-check-in')]
    #[Computed()]
    public function rows()
    {
        $query = ModelsCheckInRecord::query()
    ...
    {
        return ModelsCheckInRecord::all();
    }
    ...
    {
        return view('livewire.scan-qr.check-in-record');
    }
}
